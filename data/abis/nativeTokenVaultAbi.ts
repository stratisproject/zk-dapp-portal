export const L2_NATIVE_TOKEN_VAULT_ABI = [
  {
    inputs: [
      { internalType: "uint256", name: "_l1ChainId", type: "uint256" },
      { internalType: "address", name: "_aliasedOwner", type: "address" },
      { internalType: "bytes32", name: "_l2TokenProxyBytecodeHash", type: "bytes32" },
      { internalType: "address", name: "_legacySharedBridge", type: "address" },
      { internalType: "address", name: "_bridgedTokenBeacon", type: "address" },
      { internalType: "bool", name: "_contractsDeployedAlready", type: "bool" },
      { internalType: "address", name: "_wethToken", type: "address" },
      { internalType: "bytes32", name: "_baseTokenAssetId", type: "bytes32" },
    ],
  ...
  { inputs: [], name: "DeployingBridgedTokenForNativeToken", type: "error" },
  { inputs: [], name: "EmptyAddress", type: "error" },
  { inputs: [], name: "EmptyBytes32", type: "error" },
  { inputs: [], name: "EmptyDeposit", type: "error" },
  { inputs: [], name: "EmptyToken", type: "error" },
  { inputs: [], name: "InvalidNTVBurnData", type: "error" },
  { inputs: [], name: "NoLegacySharedBridge", type: "error" },
  { inputs: [], name: "NonEmptyMsgValue", type: "error" },
  { inputs: [], name: "TokenIsLegacy", type: "error" },
  { inputs: [], name: "TokenNotLegacy", type: "error" },
  { inputs: [{ internalType: "address", name: "token", type: "address" }], name: "TokenNotSupported", type: "error" },
  { inputs: [], name: "TokensWithFeesNotSupported", type: "error" },
  { inputs: [], name: "U32CastOverflow", type: "error" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "address", name: "bridgedTokenBeacon", type: "address" },
      { indexed: false, internalType: "bytes32", name: "bridgedTokenProxyBytecodeHash", type: "bytes32" },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "l2TokenBeacon", type: "address" },
      { indexed: true, internalType: "bytes32", name: "l2TokenProxyBytecodeHash", type: "bytes32" },
    ],
  ...
  },
  {
    inputs: [],
    name: "ASSET_ROUTER",
    outputs: [{ internalType: "contract IAssetRouterBase", name: "", type: "address" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract IL2SharedBridgeLegacy", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    name: "bridgeBurn",
    outputs: [{ internalType: "bytes", name: "_bridgeMintData", type: "bytes" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_tokenOriginChainId", type: "uint256" },
      { internalType: "address", name: "_nonNativeToken", type: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "bytes32", name: "tokenAssetId", type: "bytes32" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    name: "l2TokenAddress",
    outputs: [{ internalType: "address", name: "expectedToken", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "bytes32", name: "assetId", type: "bytes32" }],
    name: "originChainId",
    outputs: [{ internalType: "uint256", name: "originChainId", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "tokenOriginChainId", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
